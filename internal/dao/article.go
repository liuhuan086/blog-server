...
func (d *Dao) GetArticleListByTagID(id uint32, state uint8, pageOffset, pageSize int) ([]*model.ArticleRow, error) {
	article := model.Article{State: state}
	return article.ListByTagID(d.engine, id, app.GetPageOffset(pageOffset, pageSize), pageSize)
}
